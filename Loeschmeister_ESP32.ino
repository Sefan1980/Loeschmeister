...
//Pins
const int PinKontaktGlas[] = {4, 16, 17, 18, 19};                                                          // Pins der IR-Kontakte
const int PinServoDrehkranz = 34;                                                                         // Servo-Pin Drehkranz
const int PinServoLeiter = 35;                                                                            // Servo-Pin Leiter
const int PinLed = 36 ;                                                                                   // LED Pin (Neopixel)
const int PinENA = 25;                                                                                   // EnA-Pin Motortreiber (PWM-Ansteuerung)
const int PinIN1 = 26;                                                                                    // Pin IN1 Motortreiber
const int PinIN2 = 27;                                                                                    // Pin IN2 Motortreiber
const int PinPoti = 13;                                                                                  // Pin für Poti zur Füllmenge
